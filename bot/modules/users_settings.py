...
Examples:
1. <code>{escape('<b>Join: @EritsuCH</b>')}</code> 
This will give output as:
<b>Join: @EritsuCH</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @EritsuCH</code>')}</code> 
This will give output as:
<code>Join: @EritsuCH</code> <code>69MB.bin</code>.
