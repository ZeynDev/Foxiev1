...
basicConfig(format='%(levelname)s | From %(name)s -> %(module)s line no: %(lineno)d | %(message)s',
                    handlers=[FileHandler('Fox_Logs.txt'), StreamHandler()], level=INFO)

aria2 = ariaAPI(ariaClient(host="http://localhost", port=6800, secret=""))

LOGGER = getLogger(__name__)

rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://telegram.me/EritsuCH'>@Telegram</a><br><br>By<br><br><a href='https://github.com/ZeynDev/Foxiev1'>Foxiev1</a></h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            <a href="https://www.github.com/ZeynDev/Foxiev1"><i class="fab fa-github"></i></a>
            <a href="https://telegram.me/EritsuCH"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
